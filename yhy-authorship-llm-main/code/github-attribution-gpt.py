...
#博客数据集预处理
def prepare_blog_dataset(csv_path="D:\\yhy-authorship-llm-main\\data\\blogtext.csv", output_path=None):
    print("=" * 80)
...
#邮件数据集预处理
def prepare_enron_email_dataset(csv_path="D:\\yhy-jupyter\\LLM\\authorship-llm-main\\data\\emails.csv", output_path=None):
    print("=" * 80)
    ...
    system_msg = """Respond with a JSON object including two key elements:
{
  ...
  "answer": The query text's author ID.
    ...
    # 预处理博客数据集
    blog_df = prepare_blog_dataset(csv_path="D:\\yhy-authorship-llm-main\\data\\blogtext.csv", output_path="../data/blog_processed.csv")
    ...
    # 预处理Enron邮件数据集
    email_df = prepare_enron_email_dataset(csv_path="D:\\yhy-authorship-llm-main\\data\\emails.csv", output_path="../data/email_processed.csv")
